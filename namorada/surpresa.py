...
<div id="main">
  ...
  <section class="sec">
    ...
    <div class="cards">
      <div class="card reveal"><div class="medal">🥇</div><div class="cn">Melhor Performance ·</div><div class="ct">Força Inabalável</div><div class="cd">Pela capacidade de acordar antes do sol, honrar cada treino e nunca deixar que o cansaço vença a determinação. Você prova todo dia que ouro é feito de repetição — e eu tenho sorte de ver isso de perto e poder ajudar em alguns dias.</div></div>
      <div class="card reveal"><div class="medal">❤️</div><div class="cn">Prêmio do Coração ·</div><div class="ct">A Que Me Conquistou</div><div class="cd">Não foi num dia especial, não teve momento exato. Me aproximei o quanto antes porque sabia que você era a pessoa certa e eu não queria mais ninguém ao meu lado.</div></div>
